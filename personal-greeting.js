    ...
    section.innerHTML = `
      ...
      <div class="gift-card">
        ...
        <div id="digitalGift" class="gift-detail">
          <div class="gift-account"><b>BTN — Azfar Shofwan Shaquille</b><span>17901510036241</span><button type="button" class="copy-btn" data-copy="17901510036241">Salin Rekening</button></div>
          <div class="gift-account"><b>BTN — Azraf Tsaqif Alkhalifi</b><span>17901510036259</span><button type="button" class="copy-btn" data-copy="17901510036259">Salin Rekening</button></div>
        </div>
